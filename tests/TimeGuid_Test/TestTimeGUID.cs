...
namespace TimeGuid_Test
{
    ...
    #region "Value Object Tests"
        ...
        public void Equals_2TimeGuids_SameTime_EqualEachOther()
        {
            ...
            TimeGuid x = new(today);
            TimeGuid y = new(today);

            ClassicAssert.True(x.Equals(y), "A10:  The two values were the same and should have equaled each other");
        }
        ...
        public void Equals_2TimeGuids_FirstLessThanSecond_NotEqual()
        {
            ...
            TimeGuid x = new(today);
            TimeGuid y = new(today.AddMinutes(+2));

            ClassicAssert.False(x.Equals(y), "A10:  The two values were not the same and should NOT have equaled each other");
        }
        ...
        public void Equals_2TimeGuids_FirstMoreThanSecond_NotEqual()
        {
            ...
            TimeGuid x = new(today.AddMinutes(3));
            TimeGuid y = new(today);
        ...
        public void EqualitySigns_2TimeGuides_SameValue()
        {
            ...
            ClassicAssert.True(x == y, "A10:  The two values were the same and should have equaled each other");
            ClassicAssert.False(x != y, "A20:  The two values were the same and should have returned False for the != test");
        }
        ...
        public void EqualitySigns_2TimeGuides_DifferentValues()
        {
            ...
            ClassicAssert.True(x != y, "A10:  The two values were not the same and should have returned true");
            ClassicAssert.False(x == y, "A20:  The two values were different and should have returned false for == comparison");
        }
        ...
        public void CompareTo_FirstLessThanSecond()
        {
            ...
            ClassicAssert.Less(x.CompareTo(y), 0, "A10:  First value should have indicated it was less than second value.");
        }
        ...
        public void CompareTo_FirstGreaterThanSecond()
        {
            ...
            ClassicAssert.Greater(x.CompareTo(y), 0, "A10:  First value should have indicated it was more than second value.");
        }
        ...
        public void CompareTo_LessThanSymbol()
        {
            ...
            ClassicAssert.True(x < y, "A10:  x should have been less than y");
            ClassicAssert.False(y < x, "A20:  Comparison should have been false.");
        }
        ...
        public void CompareTo_GreaterThanSymbol()
        {
            ...
            ClassicAssert.True(x > y, "A10:  x should have been greater than y");
            ClassicAssert.False(y > x, "A20:  Comparison should have been false.");
        }
        ...
        public void CompareTo_LessThanOrEqualSymbol()
        {
            ...
            TimeGuid x = new(today);
            TimeGuid y = new(today.AddMinutes(2));
            TimeGuid z = new(today);

            ClassicAssert.True(x <= y, "A10:  x should have been less than y");
            ClassicAssert.True(x <= z, "A20:  x should have been equal to z");
            ClassicAssert.False(y <= x, "A30:  Comparison should have been false.");
        }
        ...
        public void CompareTo_GreaterThanOrEqualSymbol()
        {
            ...
            ClassicAssert.True(x >= y, "A10:  x should have been greater than y");
            ClassicAssert.True(x >= z, "A11:  x should have been equal to z");
            ClassicAssert.False(y >= x, "A20:  Comparison should have been false.");
        }
    ...
    #region StaticFunction Tests"
        ...
        public void HourConversion_Works([Range(0, 23)] int hr)
        {
            ...
            ClassicAssert.AreEqual(val, guidChar, "A1:  The hour did not convert to the expected ascii character.  Exp: " + val + "  Actual: " + guidValue);
        }
        ...
        public void MinuteConversion_Works([Range(0, 59)] int minute)
        {
            ...
            ClassicAssert.AreEqual(val, guidChar, "A1:  The minute did not convert to the expected ascii character.  Exp: " + val + "  Actual: " + guidValue);
        }
        ...
        public void SecondConversion_Works([Range(0, 59)] int second)
        {
            ...
            ClassicAssert.AreEqual(val, guidChar, "A1:  The second did not convert to the expected ascii character.  Exp: " + val + "  Actual: " + guidValue);
        }
        ...
        [Test]
        public void TimeGUIDConversion_Works([Random(0, 23, 5)] int hr,
                                             ...
                                             [Random(0, 59, 5)] int second)
        {
            ...
            ClassicAssert.AreEqual(valCombo, guidValue, "A1:  The TimeGuid was not converted correctly. Exp: " + valCombo + "  Actual: " + guidValue);
            ...
            if (hr1 == hr && min1 == minute && sec1 == second)
            {
                return;
            }


            DateTime d2 = new(2000,
                              01,
                              01,
                              hr1,
                              min1,
            ...
            ClassicAssert.True(x < y, "Expected the comparison of y[" + y.ToString + "] > x[" + x.ToString + "] to be true.  It was not.  Something Wrong! ");
        ...
        private static string CalculateTimeGuidPositionalValue(int digit,
                                                               string type)
        {
            int startingValue;
            ...
            else
            {
                if (digit < 8)
                {
                    startingValue = 50 + digit;
                }
                else if (digit < 34)
                {
                    startingValue = 57 + digit;
                }
                else
                {
                    startingValue = 97 + digit - 34;
                }
            }
    ...
    #region "Misc Tests"
        ...
        {
            TimeGuid x   = new(DateTime.Now);
            string   val = x;

            TimeGuid y = val;
            ClassicAssert.AreEqual(x.ToString, val, "A10:  Expected them to be same value");
            ClassicAssert.AreEqual(val, y.ToString, "A20:  Expected them to be same value");
            ClassicAssert.AreEqual(x, y, "A30: Expected them to be equal");
        }
        ...
        public void ValidateMinuteSorting([Range(0, 58)] int minute)
        {
            ...
            TimeGuid x = new(d);
            TimeGuid y = new(d.AddMinutes(1));

            ClassicAssert.True(y > x, "Expected the comparison of y[" + y.ToString + "] > x[" + x.ToString + "] to be true.  It was not.  Something Wrong! ");
        ...
        {
            TimeGuid x;
            Assert.DoesNotThrow(() => x = new(testString), "Expected a valid string to succeed - String was: " + testString);
        }
        ...
        [TestCase("AB`", false, Description = "Testing second value - ` is the last character before Ascii a that is not valid for a second.")]
        [TestCase("AB{", false, Description = "Testing second value - { is the first character after Ascii z that is not valid for a second.")]
        public void IsValidTimeGuidString_MethodWorksCorrectly(string testString,
                                                               bool expectedResult)
        {
            ClassicAssert.AreEqual(expectedResult,
                                   TimeGuid.IsValidTimeGuidString(testString),
                                   "Expected the method to return :" + expectedResult + " but it returned " + !expectedResult);
        }
